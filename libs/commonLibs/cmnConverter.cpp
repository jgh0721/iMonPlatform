    ...
    namespace nsCmnConvert
    {
        ...
        size_t CA2U8::convert( const char* szText )
        {
            ...
            do 
            {
...
#else
                errno_t err = mbstowcs( &nRetSize, NULL, 0, szText, 0 );
                if( err != 0 )
                    break;
                ...
                errno_t err = mbstowcs_s( &nRetSize, pwszBuffer, nReqSize, szText, _TRUNCATE );
                if( err != 0 )
                    break;
        ...
        size_t CU82A::convert( const char* szText )
        {
            ...
            do 
            {
                ...
                errno_t err = wcstombs_s( &nRetSize, NULL, pwszBuffer, 0 );
                if( err != 0 )
                    break;
